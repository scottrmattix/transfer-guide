...
urlpatterns = [
    ...
    path('view/request', ViewRequests.as_view(), name='viewRequests'),
    path('view/request/accept', accept_request, name='accept_request'),
    path('view/request/reject', reject_request, name='reject_request'),
